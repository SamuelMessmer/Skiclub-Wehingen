...
const NewsletterCards: React.FC = () => {
  ...
  return (
    <div>
      {loading ?
        (
          <div className="flex gap-8 items-center justify-center text-white m-8">
              ...
              <div key={blog.id} className="flex flex-col items-center gap-3 w-fit">
                <Link href="/newsletter">
                  <Image
                    ...
                    width={1920}
                    height={1080}
                    className="rounded-xl shadow-xl max-h-[400px] w-[380px] object-cover mb-5 hover:scale-105 duration-150"
                  />
                </Link>
